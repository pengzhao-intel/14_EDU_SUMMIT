...
def load_data(dataset):
    ...
    def shared_dataset(data_xy, borrow=True):
        ...
        data_y = numpy.eye(len(numpy.unique(data_y)))[data_y]
...
def write_graph(model, output_name, output_format='pdf'):
    ...
    pydot_graph = formatter(model)
    if output_format == 'png':
        pydot_graph.write_png(output_name + '.png')
    elif output_format == 'pdf':
        pydot_graph.write_png(output_name + '.pdf')
    else:
        print "only support PDF PNG"
